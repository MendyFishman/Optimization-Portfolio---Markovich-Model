...
cvx_begin
    ...
    maximize transpose(expectancy_vec)*w_Long_only;
    subject to
        transpose(w_Long_only)*Cov_mat*w_Long_only<=S;
...
x = -2*mu_Long_only:0.01:2*mu_Long_only;
y = sigma_Long_only*ones(1,size(x,2));
hold on
